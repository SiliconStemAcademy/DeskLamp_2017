...
const char* ssid = "Silicon STEM Academy";
const char* password =  "SSAtes!a52";
...
void setup() {
  ...
  Serial.println("G");
  Serial.println("Calibrating Sensor.  Wait a few seconds...");
#endif

#ifdef DEBUG
  Serial.println("Calibration Complete.  Program Starting...");
#endif
  ...
  webPage +=  "<!DOCTYPE html>\n"
              ...
              "    var msg = 'http://192.168.1.26/Parameters.html?' + data + '&T=' + (new Date()).getTime();\n"
